...
abstract class AppConstants {
  ...
  // Supabase
  static String get supabaseUrl => Api.supabaseUrl;
  static String get supabaseAnonKey => Api.supabaseAnonKey;

  // Mock Bank
  static const double initialMockBankBalance = 10000000; // 10M VND
  static const String defaultBankName = 'Mock Bank';
  
  // To reach localhost from Android emulator, use 10.0.2.2
  // To reach localhost from iOS simulator, use 127.0.0.1
  ...
  static const String mockBankApiKey = 'monikid-mockbank-secret-2024';
