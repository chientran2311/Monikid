...
import 'package:monikid/features/parent/notification/widgets/parent_notification_card.dart';
import 'package:monikid/repositories/notification/notification_repository.dart';

class ParentNotificationScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final notifAsync = ref.watch(parentNotificationStreamProvider);
    final unreadCount = ref.watch(parentUnreadNotificationCountProvider);
        ...
        body: notifAsync.when(
          ...
          data: (list) => list.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) => ParentNotificationCard(
                    notif: list[i],
