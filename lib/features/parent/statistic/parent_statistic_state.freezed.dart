...
mixin _$ParentStatisticState {
 ...
 ParentStatisticPeriod get period; ParentStatisticStatus get status; String get selectedChildId; int get totalExpenseMinor; int get prevTotalExpenseMinor; List<StatisticDailyExpenseData> get dailyData; List<StatisticCategoryData> get topCategories; List<StatisticCategoryData> get incomeCategories; DateTime? get selectedDate; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParentStatisticState&&(identical(other.period, period) || other.period == period)&&(identical(other.status, status) || other.status == status)&&(identical(other.selectedChildId, selectedChildId) || other.selectedChildId == selectedChildId)&&(identical(other.totalExpenseMinor, totalExpenseMinor) || other.totalExpenseMinor == totalExpenseMinor)&&(identical(other.prevTotalExpenseMinor, prevTotalExpenseMinor) || other.prevTotalExpenseMinor == prevTotalExpenseMinor)&&const DeepCollectionEquality().equals(other.dailyData, dailyData)&&const DeepCollectionEquality().equals(other.topCategories, topCategories)&&const DeepCollectionEquality().equals(other.incomeCategories, incomeCategories)&&(identical(other.selectedDate, selectedDate) || other.selectedDate == selectedDate)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,period,status,selectedChildId,totalExpenseMinor,prevTotalExpenseMinor,const DeepCollectionEquality().hash(dailyData),const DeepCollectionEquality().hash(topCategories),const DeepCollectionEquality().hash(incomeCategories),selectedDate,errorMessage);

@override
String toString() {
  return 'ParentStatisticState(period: $period, status: $status, selectedChildId: $selectedChildId, totalExpenseMinor: $totalExpenseMinor, prevTotalExpenseMinor: $prevTotalExpenseMinor, dailyData: $dailyData, topCategories: $topCategories, incomeCategories: $incomeCategories, selectedDate: $selectedDate, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 ParentStatisticPeriod period, ParentStatisticStatus status, String selectedChildId, int totalExpenseMinor, int prevTotalExpenseMinor, List<StatisticDailyExpenseData> dailyData, List<StatisticCategoryData> topCategories, List<StatisticCategoryData> incomeCategories, DateTime? selectedDate, String? errorMessage
});
...
/// Create a copy of ParentStatisticState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? period = null,Object? status = null,Object? selectedChildId = null,Object? totalExpenseMinor = null,Object? prevTotalExpenseMinor = null,Object? dailyData = null,Object? topCategories = null,Object? incomeCategories = null,Object? selectedDate = freezed,Object? errorMessage = freezed,}) {
...
as List<StatisticCategoryData>,incomeCategories: null == incomeCategories ? _self.incomeCategories : incomeCategories // ignore: cast_nullable_to_non_nullable
...
class _ParentStatisticState extends ParentStatisticState {
  const _ParentStatisticState({this.period = ParentStatisticPeriod.month, this.status = ParentStatisticStatus.initial, this.selectedChildId = '', this.totalExpenseMinor = 0, this.prevTotalExpenseMinor = 0, final  List<StatisticDailyExpenseData> dailyData = const [], final  List<StatisticCategoryData> topCategories = const [], final  List<StatisticCategoryData> incomeCategories = const [], this.selectedDate, this.errorMessage}): _dailyData = dailyData,_topCategories = topCategories,_incomeCategories = incomeCategories,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ParentStatisticState&&(identical(other.period, period) || other.period == period)&&(identical(other.status, status) || other.status == status)&&(identical(other.selectedChildId, selectedChildId) || other.selectedChildId == selectedChildId)&&(identical(other.totalExpenseMinor, totalExpenseMinor) || other.totalExpenseMinor == totalExpenseMinor)&&(identical(other.prevTotalExpenseMinor, prevTotalExpenseMinor) || other.prevTotalExpenseMinor == prevTotalExpenseMinor)&&const DeepCollectionEquality().equals(other._dailyData, _dailyData)&&const DeepCollectionEquality().equals(other._topCategories, _topCategories)&&const DeepCollectionEquality().equals(other._incomeCategories, _incomeCategories)&&(identical(other.selectedDate, selectedDate) || other.selectedDate == selectedDate)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,period,status,selectedChildId,totalExpenseMinor,prevTotalExpenseMinor,const DeepCollectionEquality().hash(_dailyData),const DeepCollectionEquality().hash(_topCategories),const DeepCollectionEquality().hash(_incomeCategories),selectedDate,errorMessage);
...
/// Create a copy of ParentStatisticState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? period = null,Object? status = null,Object? selectedChildId = null,Object? totalExpenseMinor = null,Object? prevTotalExpenseMinor = null,Object? dailyData = null,Object? topCategories = null,Object? incomeCategories = null,Object? selectedDate = freezed,Object? errorMessage = freezed,}) {
...
as List<StatisticCategoryData>,incomeCategories: null == incomeCategories ? _self._incomeCategories : incomeCategories // ignore: cast_nullable_to_non_nullable
as List<StatisticCategoryData>,selectedDate: freezed == selectedDate ? _self.selectedDate : selectedDate // ignore: cast_nullable_to_non_nullable
as DateTime?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
