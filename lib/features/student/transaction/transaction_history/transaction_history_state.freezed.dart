...
mixin _$TransactionHistoryState {
 ...
 List<TransactionModel> get transactions; bool get isLoading; bool get isLoadingMore; bool get isRefreshing; bool get hasMore; DateTime? get selectedDate; String? get selectedCategory; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(transactions),isLoading,isLoadingMore,isRefreshing,hasMore,selectedDate,selectedCategory,errorMessage);

@override
String toString() {
  return 'TransactionHistoryState(transactions: $transactions, isLoading: $isLoading, isLoadingMore: $isLoadingMore, isRefreshing: $isRefreshing, hasMore: $hasMore, selectedDate: $selectedDate, selectedCategory: $selectedCategory, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<TransactionModel> transactions, bool isLoading, bool isLoadingMore, bool isRefreshing, bool hasMore, DateTime? selectedDate, String? selectedCategory, String? errorMessage
});
...
/// Create a copy of TransactionHistoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? transactions = null,Object? isLoading = null,Object? isLoadingMore = null,Object? isRefreshing = null,Object? hasMore = null,Object? selectedDate = freezed,Object? selectedCategory = freezed,Object? errorMessage = freezed,}) {
...
class _TransactionHistoryState implements TransactionHistoryState {
  const _TransactionHistoryState({final  List<TransactionModel> transactions = const [], this.isLoading = true, this.isLoadingMore = false, this.isRefreshing = false, this.hasMore = true, this.selectedDate, this.selectedCategory, this.errorMessage}): _transactions = transactions;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_transactions),isLoading,isLoadingMore,isRefreshing,hasMore,selectedDate,selectedCategory,errorMessage);
...
/// Create a copy of TransactionHistoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? transactions = null,Object? isLoading = null,Object? isLoadingMore = null,Object? isRefreshing = null,Object? hasMore = null,Object? selectedDate = freezed,Object? selectedCategory = freezed,Object? errorMessage = freezed,}) {
