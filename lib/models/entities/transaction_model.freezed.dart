...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,transactionId,userId,familyId,amountMinor,currency,type,categoryKey,categoryLabel,categoryIcon,note,source,merchantName,paymentMethod,dateTs,createdAt,updatedAt,ocrUsed,ocrConfidence,evidenceImage]);

@override
String toString() {
  return 'TransactionModel(transactionId: $transactionId, userId: $userId, familyId: $familyId, amountMinor: $amountMinor, currency: $currency, type: $type, categoryKey: $categoryKey, categoryLabel: $categoryLabel, categoryIcon: $categoryIcon, note: $note, source: $source, merchantName: $merchantName, paymentMethod: $paymentMethod, dateTs: $dateTs, createdAt: $createdAt, updatedAt: $updatedAt, ocrUsed: $ocrUsed, ocrConfidence: $ocrConfidence, evidenceImage: $evidenceImage)';
}
